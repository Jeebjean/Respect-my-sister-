(function ($) {
  ...
  $(".off_canvus_menu .dropdown-menu > .dropdown > .dropdown-toggle").on(
    "click",
    function () {
      $(
        ".off_canvus_menu .dropdown-menu > .dropdown > .dropdown-toggle"
  ...
  $(".pu_accordion > .pu_accordion_item.is-active")
    .children(".pu_accordion_panel")
    .slideDown();

  $(".pu_accordion > .pu_accordion_item").on("click", function () {
    // Cancel the siblings
    $(this)
      .siblings(".pu_accordion_item")
  ...
  if (all_product_wrapper.length) {
    all_product_wrapper.simpleLoadMore({
      ...
      itemsToLoad: 3,
      btnHTML:
        '<a href="#" id="loadmore" class="cu_btn base_btn load_more_btn">See more products <i class="fas fa-chevron-down"></i></a>',
    });
  }
