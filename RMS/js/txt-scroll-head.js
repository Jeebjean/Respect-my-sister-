...
/*!/wp-content/cache/asset-cleanup/js/item/ct-ultimate-gdpr-cookie-block-v6f685b4a9613af9b68c4bc8315327a35eac439d4.js*/
/* [inline: cdata] */ var ct_ultimate_gdpr_cookie_block = {
  blocked: [],
  level: "4",
};
var ct_ultimate_gdpr_popup_close = {
  cookie_popup_button_close: "",
}; /* [/inline: cdata] */
...
if (ct_ultimate_gdpr_cookie_block && ct_ultimate_gdpr_cookie_block.blocked) {
  function ct_should_block_cookie(cookiename) {
    if (
      ...
      (ct_ultimate_gdpr_cookie_block.level < 2 ||
        ct_ultimate_gdpr_cookie_block.blocked.indexOf(cookiename) !== -1)
    ) {
      return !0;
    }
    return !1;
  ...
  try {
    var ct_ultimate_gdpr_cookie_setter_original =
      document.__lookupSetter__("cookie");
    var ct_ultimate_gdpr_cookie_getter_original =
      document.__lookupGetter__("cookie");
    var old_cookie = document.cookie;
    Object.defineProperty(document, "cookie", {
      get: function () {
        return ct_ultimate_gdpr_cookie_getter_original &&
          ct_ultimate_gdpr_cookie_getter_original.apply(document)
          ? ct_ultimate_gdpr_cookie_getter_original.apply(document)
          : this._value;
      },
      set: function (val) {
        if (
          val &&
          (val.toLowerCase().indexOf("expires=") >= 0 ||
            val.toLowerCase().indexOf("path=") >= 0 ||
            val.indexOf(";") === -1)
        ) {
          var parts = val.split(";");
          if (parts[0]) {
        ...
        this._value = val;
        ct_ultimate_gdpr_cookie_setter_original &&
...
/*!/wp-content/cache/asset-cleanup/js/item/ct-ultimate-gdpr-service-facebook-pixel-va11257ee3ffdf3543057ab85a5619a203fc668b5.js*/
/*!/wp-content/plugins/ct-ultimate-gdpr/assets/js/service-facebook-pixel.js*/
if (typeof fbq !== "undefined") {
  fbq("consent", "revoke");
}
/*!/wp-content/cache/asset-cleanup/js/item/ct-ultimate-gdpr-cookie-list-vdd07599a4c6004b55aa09fa5f1cfa5c3e8359115.js*/
/* [inline: cdata] */ var ct_ultimate_gdpr_cookie_list = {
  list: [
    {
      cookie_name: "PH-ANE-0009-01",
      cookie_type_label: "anal\u00edtica",
      first_or_third_party: "Tercera parte",
      can_be_blocked: "1",
      session_or_persistent: "Persistente",
      expiry_time: "1673772503",
      purpose: "",
    },
    {
      cookie_name: "_gaexp_rc",
      cookie_type_label: "anal\u00edtica",
      first_or_third_party: "Tercera parte",
      can_be_blocked: "1",
      session_or_persistent: "Persistente",
      expiry_time: "1658220492",
      purpose: "",
    },
    {
      cookie_name: "_gaexp",
      ...
      can_be_blocked: "1",
      session_or_persistent: "Persistente",
      expiry_time: "1663286400",
      purpose: "",
    },
    {
      cookie_name:
        "APISID, CONSENT, GPS, HSID, LOGIN_INFO, PREF, SAPISID, SID, SSID, VISITOR_INFO1_LIVE, YSC",
      cookie_type_label: "funcionalidad",
      first_or_third_party: "Tercera parte",
      can_be_blocked: "1",
      session_or_persistent: "Persistente",
      expiry_time: "",
    ...
    {
      cookie_name: "amp_e9b435_anesvad.org",
      cookie_type_label: "anal\u00edtica",
      first_or_third_party: "Tercera parte",
      can_be_blocked: "1",
      session_or_persistent: "Persistente",
      expiry_time: "1689755959",
      purpose: "",
    },
    {
      cookie_name: "__cf_bm",
      ...
      can_be_blocked: "",
      session_or_persistent: "Persistente",
      expiry_time: "1658221737.43",
      purpose: "",
    },
    {
      cookie_name: "amp_fb19e8",
      cookie_type_label: "anal\u00edtica",
      first_or_third_party: "Tercera parte",
      can_be_blocked: "1",
      session_or_persistent: "Persistente",
      expiry_time: "1689755930",
      purpose: "",
    },
    {
      cookie_name: "amp_e9b435",
      cookie_type_label: "anal\u00edtica",
      first_or_third_party: "Tercera parte",
      can_be_blocked: "1",
      session_or_persistent: "Persistente",
    ...
    {
      cookie_name: "PH-ANE-0001",
      cookie_type_label: "anal\u00edtica",
      first_or_third_party: "Tercera parte",
      can_be_blocked: "1",
      session_or_persistent: "Persistente",
      expiry_time: "1673771930",
      purpose: "",
    },
    {
      cookie_name: "_gat_PHTracker",
      cookie_type_label: "anal\u00edtica",
      first_or_third_party: "Tercera parte",
      can_be_blocked: "1",
      session_or_persistent: "Persistente",
      expiry_time: "1658219990",
      purpose: "",
    },
    {
      cookie_name: "_fbp",
      ...
      can_be_blocked: "1",
      session_or_persistent: "Persistente",
      expiry_time: "1665995931",
      purpose: "",
    },
    {
      cookie_name: "_ga_1NPBSRGB9C",
      cookie_type_label: "anal\u00edtica",
      first_or_third_party: "Tercera parte",
      can_be_blocked: "1",
      session_or_persistent: "Persistente",
      expiry_time: "1721291930",
      purpose: "",
    },
    {
      cookie_name: "_gat_UA-2711871-1",
      cookie_type_label: "anal\u00edtica",
      first_or_third_party: "Tercera parte",
      can_be_blocked: "1",
      session_or_persistent: "Persistente",
    ...
    {
      cookie_name: "__utma, __utmb, __utmc, __utmt, __utmz, _ga, _gat, _gid",
      cookie_type_label: "anal\u00edtica",
      first_or_third_party: "Tercera parte",
      can_be_blocked: "1",
      session_or_persistent: "Persistente",
    ...
    },
    {
      ...
      can_be_blocked: "1",
      session_or_persistent: "Persistente",
      expiry_time: "1665995930",
      purpose: "",
    },
    {
      cookie_name: "PH-ANE-0007",
      cookie_type_label: "anal\u00edtica",
      first_or_third_party: "Tercera parte",
      can_be_blocked: "1",
      session_or_persistent: "Persistente",
    ...
    },
    {
      ...
      can_be_blocked: "1",
      session_or_persistent: "Persistente",
      expiry_time: "1658306329.4",
      purpose: "",
    },
    {
      cookie_name: "wordpress_logged_in_f186a13f4316885f0fdb8e769d72f89d",
      cookie_type_label: "anal\u00edtica",
      first_or_third_party: "Tercera parte",
      can_be_blocked: "1",
      session_or_persistent: "Sesi\u00f3n",
      expiry_time: "",
      purpose: "",
    },
    {
      cookie_name: "wordpress_sec_f186a13f4316885f0fdb8e769d72f89d",
      cookie_type_label: "anal\u00edtica",
      first_or_third_party: "Tercera parte",
      can_be_blocked: "1",
      session_or_persistent: "Sesi\u00f3n",
...
jQuery(function () {
  function render_list(party_filter) {
    ...
    cookies.forEach((cookie) => {
      jQuery("#ct-ultimate-gdpr-cookies-table tbody").append(
        render_row(cookie)
      );
    });
  }
  function render_row(cookie) {
    ...
    for (const key in cookie) {
      ...
      } else row.append("<td>" + cookie[key] + "</td>");
    }
    return row;
  }
...
/*!/wp-content/cache/asset-cleanup/js/item/ct-ultimate-gdpr-shortcode-block-cookie-v0f201ebc37a71008e17ac2d8d2b8f842d50d3e7d.js*/
...
jQuery(document).ready(function ($) {
  ...
  function Save(e) {
    ...
    if (check_count > 0) {
      notificaton.after(
        '<p class="result-notification">Successfully submitted!</p>'
      );
    }
    if (!ct_ultimate_gdpr_cookie.reload) {
      setTimeout(function () {
...
/*!/wp-content/cache/asset-cleanup/js/item/eventmove-vf289b53fa17993df211a05dbab673eedce7fe44f.js*/
/*!/wp-content/plugins/beaf-before-and-after-gallery/assets/js/jquery.event.move.js*/
(function (fn) {
  ...
  var ignoreTags = { textarea: !0, input: !0, select: !0, button: !0 };
  var mouseevents = {
    move: "mousemove",
  ...
  var rspaces = /\s+/;
  var eventOptions = { bubbles: !0, cancelable: !0 };
...
/*!/wp-content/cache/asset-cleanup/js/item/bafg_twentytwenty-vfc16d8643603e52de0dae3a806eb274bb248d773.js*/
/*!/wp-content/plugins/beaf-before-and-after-gallery/assets/js/jquery.twentytwenty.js*/
(function ($) {
  $.fn.twentytwenty = function (options) {
    ...
    return this.each(function () {
      ...
      container.wrap(
        "<div class='twentytwenty-wrapper bafg-twentytwenty-wrapper twentytwenty-" +
          sliderOrientation +
          "'></div>"
      );
      if (!options.no_overlay) {
        ...
        var labelOutside = $(".bafg-twentytwenty-container").data(
          "label_outside"
        );
        if (labelOutside == !0 && sliderOrientation == "vertical") {
          var bafgWrapper = $(".twentytwenty-wrapper");
          bafgWrapper.wrap(
            "<div class='bafg-outside-label-wrapper twentytwenty-" +
              sliderOrientation +
              "'></div>"
          );
          var outsideLabel = $(".bafg-outside-label-wrapper");
          outsideLabel.prepend(
