  ...
  e.fn.fullpage = function (s) {
    function c() {
      s.css3 && (s.css3 = Sn()),
        ...
        d(),
        Q(),
        Dn.setAllowScrolling(!0),
        Dn.setAutoScrolling(s.autoScrolling, "internal");
      var n = e(C).find(P);
      n.length &&
        (0 !== e(C).index(T) || (0 === e(C).index(T) && 0 !== n.index())) &&
        Ln(n),
        Ge(),
        gn(),
        ie.on("load", function () {
    ...
    function f() {
      ie.on("scroll", de).on("hashchange", ze).blur(Ye).resize(Qe),
        re
          .keydown(Oe)
          .keyup(Ie)
          .on("click touchstart", F + " a", Ue)
          .on("click touchstart", j, Xe)
          .on("click", q, De),
        e(T).on("click touchstart", G, We),
        s.normalScrollElements &&
          (re.on("mouseenter", s.normalScrollElements, function () {
    ...
    function Q() {
      Xn.css({ height: "100%", position: "relative" }),
        ...
        s.fixedElements && s.css3 && e(s.fixedElements).appendTo(On),
        s.navigation && se(),
        s.scrollOverflow
          ? ("complete" === o.readyState && ce(), ie.on("load", ce))
          : fe();
    }
    function Z(n, o, t) {
      var i = 100 * t,
      ...
      o.wrapAll('<div class="' + Y + '" />'),
        ...
        t > 1 && (s.controlArrows && le(n), s.slidesNavigation && hn(n, t)),
        o.each(function (n) {
          e(this).css("width", r + "%"), s.verticalCentered && an(e(this));
        });
      var a = n.find(P);
      a.length &&
      (0 !== e(C).index(T) || (0 === e(C).index(T) && 0 !== a.index()))
        ? Ln(a)
        : o.eq(0).addClass(g);
    }
    function ee(n, o) {
      o || 0 !== e(C).length || n.addClass(g),
        ...
        "undefined" != typeof s.sectionsColor[o] &&
          n.css("background-color", s.sectionsColor[o]),
        "undefined" != typeof s.anchors[o] &&
          n.attr("data-anchor", s.anchors[o]);
    }
    function ne(n, o) {
      "undefined" != typeof s.anchors[o] &&
        n.hasClass(g) &&
        ...
        s.menu &&
          s.css3 &&
          e(s.menu).closest(l).length &&
          e(s.menu).appendTo(On);
    }
    function ae() {
    ...
    function le(e) {
      e
        .find(W)
        .after('<div class="' + $ + '"></div><div class="' + oe + '"></div>'),
    ...
    function fe() {
      ...
      n.addClass(w),
        ...
        e.isFunction(s.afterLoad) &&
          s.afterLoad.call(n, n.data("anchor"), n.index(T) + 1),
    ...
    function de() {
      ...
      if (!s.autoScrolling || s.scrollBar) {
        ...
        if (
          (ue(i) &&
            (e(C).hasClass(w) || e(C).addClass(w).siblings().removeClass(w)),
          (n = e(l).eq(r)),
          !n.hasClass(g))
        ) {
          io = !0;
          ...
          if (m.length)
            var S = m.data("anchor"),
              y = m.index();
          Qn &&
            (n.addClass(g).siblings().removeClass(g),
            e.isFunction(s.onLeave) && s.onLeave.call(d, u, v, h),
            e.isFunction(s.afterLoad) && s.afterLoad.call(n, p, v),
            Ee(n),
            nn(p, v - 1),
            s.anchors.length && ((In = p), pn(y, S, p, v))),
            clearTimeout(eo),
    ...
    function pe(e, n) {
      if (Jn.m[e]) {
        ...
        if (
          ("down" == e
            ? ((o = "bottom"), (t = Dn.moveSectionDown))
            : ((o = "top"), (t = Dn.moveSectionUp)),
          n.length > 0)
        ) {
    ...
    function ve(n) {
      ...
      if (!me(n.target) && ge(o)) {
        ...
        if (Qn && !Wn) {
          ...
          (so = a.y),
            (co = a.x),
            i.find(W).length && t.abs(lo - co) > t.abs(ao - so)
              ? t.abs(lo - co) > (ie.outerWidth() / 100) * s.touchSensitivity &&
                (lo > co
                  ? Jn.m.right && Dn.moveSlideRight()
                  : Jn.m.left && Dn.moveSlideLeft())
              : s.autoScrolling &&
                t.abs(ao - so) > (ie.height() / 100) * s.touchSensitivity &&
                (ao > so ? pe("down", r) : so > ao && pe("up", r));
        }
      }
    }
    function me(n, o) {
      o = o || 0;
      var t = e(n).parent();
      return o < s.normalScrollElementTouchThreshold &&
        t.is(s.normalScrollElements)
        ? !0
        : o == s.normalScrollElementTouchThreshold
        ? !1
        : me(t, ++o);
    }
    function ge(e) {
    ...
    function we(e, n) {
      for (
        var o = 0, i = e.slice(t.max(e.length - n, 1)), r = 0;
        r < i.length;
        r++
      )
        o += i[r];
    ...
    function Ce(n, o, t) {
      requestAnimFrame(function () {
        ...
        if ("undefined" != typeof i) {
          ...
          if (
            !(
              (a.activeSection.is(n) && !Kn) ||
              (s.scrollBar && ie.scrollTop() === a.dtop && !n.hasClass(M))
            )
          ) {
            if (a.activeSlide.length)
              var l = a.activeSlide.data("anchor"),
            ...
            s.autoScrolling &&
              ...
              (!e.isFunction(s.onLeave) ||
                ...
                Ee(n),
                (Qn = !1),
                pn(c, l, a.anchorLink, a.sectionIndex),
                ke(a),
                (In = a.anchorLink),
                nn(a.anchorLink, a.sectionIndex));
          }
        }
      });
    }
    ...
    function Le(n) {
      return (
        n.isMovementUp
          ? e(C).before(n.activeSection.nextAll(T))
          : e(C).after(n.activeSection.prevAll(T).get().reverse()),
        Bn(e(C).position().top),
        xe(),
    ...
    function Be(n) {
      n.wrapAroundElements &&
        ...
        (n.isMovementUp
          ? e(k).before(n.wrapAroundElements)
          : e(A).after(n.wrapAroundElements),
        Bn(e(C).position().top),
        xe());
    }
    function Me(n) {
    ...
    function Ee(n) {
      var n = He(n);
      n.find("img[data-src], source[data-src], audio[data-src]").each(
        function () {
    ...
    function We() {
      ...
      e(this).hasClass(J)
        ? Jn.m.left && Dn.moveSlideLeft(n)
        : Jn.m.right && Dn.moveSlideRight(n);
    }
    function Ye() {
      (jn = !1), (Vn = !1);
    }
    ...
    function Ke(e) {
      Qn &&
        (e.pageY < ho && Jn.m.up
          ? Dn.moveSectionUp()
          : e.pageY > ho && Jn.m.down && Dn.moveSectionDown()),
        (ho = e.pageY);
    }
    function je(n, o) {
      var i = o.position(),
      ...
      if (s.onSlideLeave) {
        ...
        if (
          ...
          s.onSlideLeave.call(u, c, l + 1, p, v, r) === !1
        )
          return void (Wn = !1);
      }
      Fe(u),
        ...
        !s.loopHorizontal &&
          s.controlArrows &&
          (a.find(_).toggle(0 !== r), a.find(te).toggle(!o.is(":last-child"))),
        a.hasClass(g) && pn(r, d, c, l);
      var m = function () {
        h ||
          (e.isFunction(s.afterSlideLoad) &&
            s.afterSlideLoad.call(o, c, l + 1, d, r)),
          Re(o),
          (Wn = !1);
      };
      if (s.css3) {
        var w = "translate3d(-" + t.round(i.left) + "px, 0px, 0px)";
        Je(n.find(U), s.scrollingSpeed > 0).css(Mn(w)),
          (_n = setTimeout(
            function () {
              m();
            },
    ...
    function Ge() {
      var e = s.responsive || s.responsiveWidth,
        ...
        t = n && ie.height() < n;
      e && n
        ? Dn.setResponsive(o || t)
        : e
        ? Dn.setResponsive(o)
        : n && Dn.setResponsive(t);
    }
    function Je(e) {
      var n = "all " + s.scrollingSpeed + "ms " + s.easingcss3;
      return (
        e.removeClass(h), e.css({ "-webkit-transition": n, transition: n })
      );
    }
    function Ze(e) {
      return e.addClass(h);
    ...
    function _e(n, o) {
      s.navigation &&
        (e(F).find(S).removeClass(g),
        n
          ? e(F)
              .find('a[href="#' + n + '"]')
              .addClass(g)
          : e(F).find("li").eq(o).find("a").addClass(g));
    }
    function en(n) {
      s.menu &&
        (e(s.menu).find(S).removeClass(g),
        e(s.menu)
    ...
    function rn(e) {
      ...
      r.length
        ...
        : ((n = e.get(0).scrollHeight),
          s.verticalCentered && (n = e.find(B).get(0).scrollHeight));
      var a =
        Nn - parseInt(i.css("padding-bottom")) - parseInt(i.css("padding-top"));
      n > a
        ? r.length
          ? o.update(e, a)
          : (s.verticalCentered ? e.find(B).wrapInner(t) : e.wrapInner(t),
            o.create(e, a))
        : o.remove(e),
        e.css("overflow", "");
    }
    function an(e) {
      e.addClass(X).wrapInner(
        '<div class="' + L + '" style="height:' + ln(e) + 'px;" />'
      );
    }
    function ln(e) {
      var n = Nn;
    ...
    function gn() {
      ...
      (On[0].className = On[0].className.replace(a, "")),
        On.addClass(m + "-" + r);
    }
    function Sn() {
      var e,
      ...
      for (var a in r)
        t.style[a] !== i &&
          ...
          (e = n.getComputedStyle(t).getPropertyValue(r[a])));
      return o.body.removeChild(t), e !== i && e.length > 0 && "none" !== e;
    }
    function wn() {
      o.addEventListener
        ? (o.removeEventListener("mousewheel", ye, !1),
          o.removeEventListener("wheel", ye, !1),
          o.removeEventListener("MozMousePixelScroll", ye, !1))
        : o.detachEvent("onmousewheel", ye);
    }
    function yn() {
      var e,
        t = "";
      ...
      var r =
        "onwheel" in o.createElement("div")
          ...
          : "DOMMouseScroll";
      "DOMMouseScroll" == r
        ? o[e](t + "MozMousePixelScroll", ye, !1)
        : o[e](t + r, ye, !1);
    }
    function bn() {
    ...
    function Ln(e, n) {
      Dn.setScrollingSpeed(0, "internal"),
        "undefined" != typeof n && (Kn = !0),
        je(e.closest(W), e),
        "undefined" != typeof n && (Kn = !1),
    ...
    function Rn() {
      Bn(0),
        ...
        zn.css({ overflow: "", height: "" }),
        e("html").removeClass(v),
        e.each(On.get(0).className.split(/\s+/), function (e, n) {
    ...
    (s = e.extend(
      ...
      (Dn.setAutoScrolling = function (n, o) {
        ...
        var t = e(C);
        s.autoScrolling && !s.scrollBar
          ? (zn.css({ overflow: "hidden", height: "100%" }),
            Dn.setRecordHistory(to.recordHistory, "internal"),
            Xn.css({ "-ms-touch-action": "none", "touch-action": "none" }),
            t.length && Bn(t.position().top))
          : (zn.css({ overflow: "visible", height: "initial" }),
            Dn.setRecordHistory(!1, "internal"),
            Xn.css({ "-ms-touch-action": "", "touch-action": "" }),
            Bn(0),
            t.length && zn.scrollTop(t.position().top));
      }),
      ...
      (Dn.setAllowScrolling = function (n, o) {
        "undefined" != typeof o
          ...
          : n
          ? (Dn.setMouseWheelScrolling(!0), Tn())
          : (Dn.setMouseWheelScrolling(!1), Cn());
      }),
              ...
              s.verticalCentered &&
                ...
                s.scrollOverflow &&
                  (o.length
                    ...
                    : rn(e(this))),
                o.length > 1 && je(n, n.find(P));
            });
          var t = e(C),
            i = t.index(T);
          i && Dn.silentMoveTo(i + 1),
            (Kn = !1),
            requestAnimFrame(function () {
              Kn = !1;
            }),
            e.isFunction(s.afterResize) && n && s.afterResize.call(Xn),
            e.isFunction(s.afterReBuild) && !n && s.afterReBuild.call(Xn);
        }
      }),
      (Dn.setResponsive = function (n) {
        ...
        n
          ? o ||
            (Dn.setAutoScrolling(!1, "internal"),
            Dn.setFitToSection(!1, "internal"),
            e(F).hide(),
            On.addClass(u))
          : o &&
            (Dn.setAutoScrolling(to.autoScrolling, "internal"),
            Dn.setFitToSection(to.autoScrolling, "internal"),
            e(F).show(),
            On.removeClass(u));
      });
    var In,
      ...
      Gn = [],
      Jn = {};
    (Jn.m = { up: !0, down: !0, left: !0, right: !0 }),
    ...
    Dn.destroy = function (n) {
      Dn.setAutoScrolling(!1, "internal"),
        Dn.setAllowScrolling(!1),
        Dn.setKeyboardScrolling(!1),
        Xn.addClass(p),
        clearTimeout(_n),
        clearTimeout($n),
        clearTimeout(Zn),
        clearTimeout(eo),
        clearTimeout(no),
        ie.off("scroll", de).off("hashchange", ze).off("resize", Qe),
        re
          .off("click", F + " a")
          .off("mouseenter", F + " li")
          .off("mouseleave", F + " li")
