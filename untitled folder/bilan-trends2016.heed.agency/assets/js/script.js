...
function resolveChapters() {
  ...
  TweenLite.to(".previous-border", 0, {
    borderColor: colours[previousChapter],
    delay: 1,
  });
  TweenLite.to(".next-border", 0, {
    borderColor: colours[nextChapter],
    delay: 1,
  });
}
...
function registerHandlers() {
    ...
    if (currentState == 0) {
      ...
      if (currentDetail == 0 && currentPanel == currentState) {
        ...
        if (animating <= 0 && changinSlide == false) {
          ...
          TweenLite.to(".container-chapter", 0.5, {
            opacity: 0,
            display: "none",
            ease: "Power1.easeInOut",
          });
          TweenLite.to(".detail-text", 0, {
            opacity: 0,
            display: "none",
            delay: 0,
          });
          ...
          TweenLite.to(".container-chapter-0" + currentState, 0, {
            opacity: 1,
            display: "block",
            ease: "Power1.easeInOut",
            delay: 0.7,
          ...
          TweenLite.to(".detail-center > .background", 0, {
            backgroundColor: colours[previousChapter],
            delay: 0.3,
          });
          TweenLite.to(".detail-center > .background", 0.3, {
            height: "52px",
          ...
          setTimeout(function () {
            ...
            if (
              (currentDetail < currentState ||
                (currentDetail == 3 && currentState == 1)) &&
              !(currentDetail == 1 && currentState == 3)
            ) {
              $.fn.fullpage.moveSectionDown();
            } else {
              $.fn.fullpage.moveSectionUp();
  ...
  $(".revenir").mouseenter(function () {
    TweenLite.to(".revenir > .underline", 0.25, {
      scaleX: 0,
  ...
  $(".btn-final-decouvrir-right").mouseenter(function () {
    TweenLite.to(".final-next > .decouvrir > .underline", 0.25, {
      scaleX: 0,
      transformOrigin: "right",
      ease: "Power2.easeInOut",
    });
  ...
  $(".btn-final-decouvrir-left").mouseenter(function () {
    TweenLite.to(".final-previous > .decouvrir > .underline", 0.25, {
      scaleX: 0,
      transformOrigin: "right",
      ease: "Power2.easeInOut",
    });
    ...
    if (currentDetail == 1) {
      if (chapterTriggers01[1] == false) {
        if ($(".chapter-01-box-video-01").offset().top - vHeight + 100 <= 0) {
          ...
          TweenLite.to(".video-play-1 > .circle-component", 0.5, {
            rotation: "+=90deg",
            delay: 1,
          });
          TweenLite.to(".video-play-1 > .circle-component", 0, {
            rotation: "-=90deg",
            delay: 1.5,
          });
          TweenLite.to(".video-play-1 > .video-play-arrow", 0.5, {
            opacity: 1,
            delay: 1,
          });

          TweenLite.fromTo(
            ".chapter-01-box-video-01",
            1.5,
            { left: vWidth / 2 - 10 + "px" },
            { width: "540px", left: "0px", ease: "Power4.easeOut" }
          );
          TweenLite.fromTo(
            ".video-title-chapter-01-01",
            0.7,
            { bottom: "100px" },
            { bottom: "118px", opacity: 1, ease: "Power2.easeInOut", delay: 1 }
          );
        }
        ...
        if ($(".chapter-01-bg-row-02").offset().top - vHeight + 100 <= 0) {
          ...
          TweenLite.fromTo(
            ".chapter-01-bg-row-02",
            1.5,
            { width: "0px" },
            { width: vWidth / 2 - 40 + "px", ease: "Power4.easeOut" }
          );
          TweenLite.to(".chapter-01-bg-row-02", 0, {
            width: "calc(100% - 30px)",
            delay: 1.5,
          });
        }
        ...
        if ($(".chapter-01-box-video-02").offset().top - vHeight + 100 <= 0) {
          ...
          TweenLite.to(".video-play-2 > .circle-component", 0.5, {
            rotation: "+=90deg",
            delay: 1,
          });
          TweenLite.to(".video-play-2 > .circle-component", 0, {
            rotation: "-=90deg",
            delay: 1.5,
          });
          TweenLite.to(".video-play-2 > .video-play-arrow", 0.5, {
            opacity: 1,
            delay: 1,
          });

          TweenLite.fromTo(
            ".chapter-01-box-video-02",
            1.5,
            { right: vWidth / 2 - 10 + "px" },
            { width: "540px", right: "0px", ease: "Power4.easeOut" }
          );
          TweenLite.fromTo(
            ".video-title-chapter-01-02",
            0.7,
            { bottom: "100px" },
            { bottom: "118px", opacity: 1, ease: "Power2.easeInOut", delay: 1 }
          );
        ...
        if ($(".chapter-01-bg-row-03").offset().top - vHeight + 100 <= 0) {
          ...
          TweenLite.fromTo(
            ".chapter-01-bg-row-03",
            1.5,
            { width: "0px" },
            { width: vWidth / 2 - 40 + "px", ease: "Power4.easeOut" }
          );
          TweenLite.to(".chapter-01-bg-row-03", 0, {
            width: "calc(100% - 30px)",
            delay: 1.5,
          });
        }
        ...
        if ($(".chapter-01-box-video-03").offset().top - vHeight + 100 <= 0) {
          ...
          TweenLite.to(".video-play-3 > .circle-component", 0.5, {
            rotation: "+=90deg",
            delay: 1,
          });
          TweenLite.to(".video-play-3 > .circle-component", 0, {
            rotation: "-=90deg",
            delay: 1.5,
          });
          TweenLite.to(".video-play-3 > .video-play-arrow", 0.5, {
            opacity: 1,
            delay: 1,
          });

          TweenLite.fromTo(
            ".chapter-01-box-video-03",
            1.5,
            { left: vWidth / 2 - 10 + "px" },
            { width: "540px", left: "0px", ease: "Power4.easeOut" }
          );
          TweenLite.fromTo(
            ".video-title-chapter-01-03",
            0.7,
            { bottom: "100px" },
            { bottom: "118px", opacity: 1, ease: "Power2.easeInOut", delay: 1 }
          );
      ...
      if (chapterTriggers02[1] == false) {
        if ($(".chart-bg-row-01-back").offset().top - vHeight + 100 <= 0) {
          ...
          TweenLite.to(".chart-bg-row-01-back", 1, {
            scaleX: 1,
            x: "0%",
            ease: "Power1.easeInOut",
          });
          TweenLite.to(".chart-bg-row-01-front", 1, {
            scaleX: 1,
            x: "0%",
            ease: "Power1.easeInOut",
          });
          TweenLite.to(".chart-bg-row-01-front > .window", 1, {
            width: "100%",
            ease: "Power1.easeInOut",
          });
        }
      ...
      if (chapterTriggers02[2] == false) {
        if ($(".chart-bg-row-01-front").offset().top - vHeight + 100 <= 0) {
          ...
          TweenLite.to(
            ...
            1.5,
            { rotation: "225deg", ease: "Power2.easeInOut", delay: 0 }
          );
          TweenLite.to(
          ...
          TweenLite.to(
            ...
            1.5,
            { rotation: "110deg", ease: "Power2.easeInOut", delay: 0 }
          );
          TweenLite.to(
          ...
          TweenLite.fromTo(
            ".video-title-chapter-02-01",
            0.7,
            { bottom: "130px" },
            { bottom: "148px", opacity: 1, ease: "Power2.easeInOut", delay: 1 }
          );
        }
      }
      if (chapterTriggers02[3] == false) {
        if ($(".chart-bg-row-02-back").offset().top - vHeight + 100 <= 0) {
          ...
          TweenLite.to(".chart-bg-row-02-back", 1, {
            scaleX: 1,
            x: "0%",
            ease: "Power1.easeInOut",
          });
          TweenLite.to(".chart-bg-row-02-front", 1, {
            scaleX: 1,
            x: "0%",
            ease: "Power1.easeInOut",
          });
          TweenLite.to(".chart-bg-row-02-front > .window", 1, {
            width: "100%",
            ease: "Power1.easeInOut",
          });
        }
      ...
      if (chapterTriggers02[4] == false) {
        if ($(".chart-bg-row-02-front").offset().top - vHeight + 100 <= 0) {
          ...
          TweenLite.to(".chapter-02-chart-02 > .graph", 1.5, {
            height: "100%",
            ease: "Power1.easeInOut",
            delay: 0.2,
          });
          ...
          TweenLite.fromTo(
            ".video-title-chapter-02-02",
            0.7,
            { bottom: "120px" },
            { bottom: "138px", opacity: 1, ease: "Power2.easeInOut", delay: 1 }
          );
        }
      }
      if (chapterTriggers02[5] == false) {
        if ($(".chart-bg-row-03-back").offset().top - vHeight + 100 <= 0) {
          ...
          TweenLite.to(".chart-bg-row-03-back", 1, {
            scaleX: 1,
            x: "0%",
            ease: "Power1.easeInOut",
          });
          //TweenLite.to(".chart-bg-row-03-back", 1, {scaleX: 1, x: "0%", ease: "Power1.easeInOut"});
          TweenLite.to(".chart-bg-row-03-front", 1, {
            scaleX: 1,
            x: "0%",
            ease: "Power1.easeInOut",
          });
          TweenLite.to(".chart-bg-row-03-front > .window", 1, {
            width: "100%",
            ease: "Power1.easeInOut",
          });
        }
      ...
      if (chapterTriggers03[1] == false) {
        if ($(".chapter-03-bg-1").offset().top - vHeight + 100 <= 0) {
          ...
          TweenLite.to(".chapter-03-bg-1", 1.5, {
            scaleX: 1,
            x: 0,
            ease: "Power1.easeInOut",
          });
        ...
        if ($(".chapter-03-box-video-01").offset().top - vHeight + 100 <= 0) {
          ...
          TweenLite.to(".chapter-03-bg-2", 1.2, {
            scaleX: 1,
            x: 0,
            ease: "Power1.easeInOut",
          });
          TweenLite.to(".chapter-03-box-video-01", 1.2, {
            x: 0,
            ease: "Power4.easeOut",
            delay: 0.4,
          });
          TweenLite.to(".chapter-03-box-video-01 > .window", 1.7, {
            width: "100%",
            ease: "Power4.easeOut",
            delay: 0.4,
          });
          ...
          TweenLite.fromTo(
            ...
            0.2,
            { opacity: 0 },
            { opacity: 1, delay: 1.39 }
          );
          drawCircle(".video-play-4 > .video-play-circle-large", 0.5, 1.4);
          drawCircle(".video-play-4 > .video-play-circle-small", 0.5, 1.4);
          TweenLite.to(".video-play-4 > .circle-component", 0.5, {
            rotation: "+=90deg",
            delay: 1.4,
          });
          TweenLite.to(".video-play-4 > .circle-component", 0, {
            rotation: "-=90deg",
            delay: 1.9,
          });
          TweenLite.to(".video-play-4 > .video-play-arrow", 0.5, {
            opacity: 1,
            delay: 1.4,
          });
  ...
  $(".navigation-circle-left")
    .mouseover(function () {
      TweenLite.to(".section-chapter-0" + previousChapter, 0, {
        fontWeight: "bold",
      });
    })
  ...
  $(".navigation-circle-right")
    .mouseover(function () {
      TweenLite.to(".section-chapter-0" + nextChapter, 0, {
        fontWeight: "bold",
      });
    })
  ...
  $(".cta-btn").mouseover(function () {
    if (vWidth > 940 && animatinga["cta"] == false) {
      ...
      TweenLite.fromTo(
        ...
        0.3,
        { top: "0px", opacity: 1 },
        { top: "-8px", opacity: 0, ease: "Power2.easeOut" }
      );
      setTimeout(function () {
        if (currentDetail == 0) {
          TweenLite.fromTo(
            ...
            0.3,
            { top: "8px", opacity: 0 },
            { top: "0px", opacity: 1, delay: 0, ease: "Power2.easeOut" }
          );
        }
        setTimeout(function () {
          animatinga["cta"] = false;
  ...
  $(".detail-continue").click(function () {
  ...
  $(".btn-final-previous")
    .mouseover(function () {
      TweenLite.fromTo(
        ...
        0.3,
        { scale: 0.7, opacity: 0 },
        { scale: 1, opacity: 1, ease: "Power3.easeOut" }
      );
    })
    ...
    .click(function () {
      ...
      TweenLite.to(".container-chapter-0" + currentPanel, 0.5, {
        opacity: 0,
        display: "none",
        ease: "Power1.easeInOut",
      });
      ...
      TweenLite.to(".container-chapter-0" + previousChapter, 0, {
        opacity: 1,
        display: "block",
        ease: "Power1.easeInOut",
        delay: 0.7,
      ...
      window.history.pushState(
        previousChapter,
        "Chapter 0" + previousChapter,
        "#chapter0" + previousChapter
      );
    });
  ...
  $(".btn-final-next")
    ...
    .click(function () {
      ...
      TweenLite.to(".container-chapter-0" + nextChapter, 0, {
        opacity: 1,
        display: "block",
        ease: "Power1.easeInOut",
        delay: 0.7,
      ...
      TweenLite.to(".detail-center > .background", 0, {
        backgroundColor: colours[nextChapter],
        delay: 0.3,
      });
      TweenLite.to(".detail-center > .background", 0.3, {
        height: "52px",
      ...
      window.history.pushState(
        nextChapter,
        "Chapter 0" + nextChapter,
        "#chapter0" + nextChapter
      );
    });

  $(".heed").mouseenter(function () {
    if (vWidth > tabletWidth) {
      TweenLite.fromTo(
        ".heed-credits > .underline-white",
        0.25,
    ...
    .click(function () {
      if (vWidth > tabletWidth) {
        if (animatinga["popup"] == false) {
          ...
          TweenLite.to(".popup", 0, { height: "9%" });
          TweenLite.to(".logo", 0, { display: "none" });
          TweenLite.to(".popup, .popup-background", 0.5, {
            width: "80%",
            ease: "Power2.easeOut",
            display: "flex",
          });
          setTimeout(function () {
            if (state["popup"] == false) {
              ...
              TweenLite.to(".popup-background", 0.5, {
                width: "0px",
                ease: "Power2.easeIn",
              });
    ...
    .mouseleave(function () {
      if (vWidth > tabletWidth) {
        if (animatinga["popup"] == false) {
          ...
          TweenLite.to(".popup", 0.4, { width: "130px" });
          TweenLite.to(".logo", 0, { display: "block" });
          TweenLite.to(".popup-background", 0.5, {
            width: "0px",
            ease: "Power2.easeIn",
          });
  ...
  $(".video-mobile-play").click(function () {
    var id = $(this).attr("data-videoId");
    activeVideo = "1" + id;

    TweenLite.to(
      ".video-mobile-popup-box-" + id + ", .video-mobile-exit",
      0.5,
  ...
  $(".video-mobile-exit").click(function () {
    TweenLite.to(".video-mobile-popup-box, .video-mobile-exit", 0.5, {
      opacity: 0,
      display: "none",
    });
  ...
  $(".popup-tablet-exit").click(function () {
    if (vWidth <= tabletWidth) {
      animatinga["popup"] = true;
      state["popup"] = false;
      TweenLite.to(".popup", 0.4, { width: "130px" });
  ...
  $(".partager")
    .click(function () {
      if (animatinga["partager"] == false) {
        animatinga["partager"] = true;
        TweenLite.to(".partager-box > .partager", 0.2, {
          opacity: 0,
          display: "none",
        });
        TweenLite.to(".partager-box > .expanded", 0.2, {
          opacity: 1,
          display: "block",
        });
        TweenLite.fromTo(
          ".partager-box > .expanded > .img-1",
          0.3,
          { x: "60px" },
          { x: "0px" }
        );
        TweenLite.fromTo(
          ".partager-box > .expanded > .img-2",
          0.3,
          { x: "30px" },
          { x: "0px" }
        );
        TweenLite.fromTo(
          ".partager-box > .expanded > .img-3",
          0.3,
          { x: "10px" },
          { x: "0px" }
        );
        TweenLite.fromTo(
          ".partager-box > .expanded > .cross",
          0.3,
          { scale: 0.1, rotation: "-315deg" },
          { scale: 1, rotation: "45deg" }
        );
        TweenLite.to(".partager > .underline", 0.3, { scaleX: 0, x: "29px" });
        setTimeout(function () {
          animatinga["partager"] = false;
        }, 350);
      }
    ...
    .mouseenter(function () {
      if (animatinga["partager"] == false && vWidth > tabletWidth) {
        TweenLite.fromTo(
  ...
  $(".cross").click(function () {
    if (animatinga["partager"] == false) {
      animatinga["partager"] = true;
      TweenLite.to(".partager-box > .partager", 0.3, {
        opacity: 1,
        display: "block",
        delay: 0.2,
      });
      TweenLite.to(".partager-box > .expanded", 0.3, {
        opacity: 0,
        display: "none",
      });
      TweenLite.fromTo(
      ...
      TweenLite.to(".partager-box > .expanded > .cross", 0.3, {
        scale: 0.1,
        rotation: "+=360deg",
      });
      TweenLite.fromTo(
      ...
      TweenLite.to(".partager > .underline-white", 0, {
        scaleX: 0,
        x: "-59px",
      });
      setTimeout(function () {
  ...
  $(".info-dot")
    .mouseover(function () {
      ...
      TweenLite.to(".info-dot-text-" + id, 0.5, {
        display: "block",
        opacity: 1,
        ease: "Power1.easeInOut",
      });
    ...
    .mouseout(function () {
      TweenLite.to(".info-dot-text-" + $(this).attr("infoDot"), 0.5, {
        display: "none",
        opacity: 0,
        ease: "Power2.easeInOut",
      });
        ...
        if (myVideo.paused) {
          ...
          for (var i = 1; i <= 3; i++) {
            if (i != id) {
              ...
              TweenLite.to(".chapter-01-window-video-0" + i, 0.2, {
                scale: 1,
                ease: "Power1.easeIn",
              });
              TweenLite.to(".chapter-01-window-video-0" + i + " > img", 0.2, {
                opacity: 1,
                ease: "Power1.easeOut",
              });
  ...
  $(".chapter-03-box-video-01")
    .mouseenter(function () {
      ...
      $(".chapter-03-box-video-01").mouseenter(function () {
    ...
    .mouseleave(function () {
      ...
      if (vWidth > tabletWidth) {
        TweenLite.to(
          ".chapter-03-box-video-01 > .window > img, .chapter-03-box-video-01 > .window > .video4",
          0.2,
          { scale: 1, opacity: 1, ease: "Power1.easeIn" }
        );
  ...
  $(".video-play").mouseenter(function () {
    if (vWidth > tabletWidth) {
      ...
      TweenLite.fromTo(
        ".video-play-" + id + " > .video-play-arrow",
        0.2,
        { x: "0px", opacity: 1 },
        { x: "8px", opacity: 0 }
      );
      TweenLite.fromTo(
        ...
        0.3,
        { x: "-8px", opacity: 0 },
        { x: "0px", opacity: 1, delay: 0.2, ease: "Power2.easeOut" }
      );
    }
  });
...
function prepareCircles(debug) {
  var circleParts =
    '<div class="circle-window-left"><div class="circle-part-left circle-part"></div></div><div class="circle-window-right"><div class="circle-part-right circle-part"></div></div>';
...
function updateLayout() {
  ...
  if (loading == false) {
    if (currentDetail == 2) {
      if (chapterTriggers02[1] == false) {
        TweenLite.to(".chart-bg-row-01-back", 0, {
          scaleX: 0.5,
          x: -vWidth / 2,
        });
      } else if (chapterTriggers02[3] == false) {
        TweenLite.to(".chart-bg-row-02-back", 0, {
          scaleX: 0.5,
          x: vWidth / 2,
        });
      } else if (chapterTriggers02[5] == false) {
        TweenLite.to(".chart-bg-row-03-back", 0, {
          scaleX: 0.5,
          x: -vWidth / 2,
        });
      }
